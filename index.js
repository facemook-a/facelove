// FaceLove - Simple Working Version
    ...
    <head>
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .top-nav a{ color: #888; font-size: 16px; text-decoration: none; transition: 0.3s; }
        ...
        .bottom-nav a{
          color: #555; font-size: 18px; text-decoration: none; text-align: center; transition: 0.3s;
        }
        ...
        .post-box .actions .btn-post{
          background: linear-gradient(135deg, #ff3b5c, #ff6b8a);
          border: none; padding: 6px 18px; border-radius: 30px;
        ...
        .feed-post .actions{
          display: flex; gap: 14px; padding-top: 6px; border-top: 1px solid #1f1f1f;
        }
        ...
        .feed-post .comments{
          margin-top: 8px; padding-top: 8px; border-top: 1px solid #1f1f1f;
        }
        ...
        .friend-item .actions .btn-sm{
          padding: 3px 10px; border: none; border-radius: 30px;
        ...
        .chat-messages .msg{
          margin: 2px 0; padding: 3px 8px; border-radius: 6px; font-size: 12px;
        }
        ...
        .chat-input input{
          flex: 1; padding: 6px 12px; background: #1a1a1a;
          border: 2px solid transparent; border-radius: 30px; color: #fff;
          font-size: 12px; outline: none; transition: 0.3s;
        }
        .chat-input input:focus{ border-color: #ff3b5c; }
        .chat-input button{
          padding: 6px 14px; background: linear-gradient(135deg, #ff3b5c, #ff6b8a);
        ...
        .profile-header .avatar{
          ...
          background: linear-gradient(135deg, #ff3b5c, #ff6b8a);
          display: flex; align-items: center; justify-content: center;
          font-size: 24px; font-weight: 700; color: #fff; margin: 0 auto 8px;
        }
        ...
        .profile-header .edit-btn{
          margin-top: 10px; padding: 5px 16px; background: #1a1a1a;
          border: 1px solid #1f1f1f; border-radius: 30px; color: #fff;
        ...
        .admin-item .badge{
          font-size: 8px; padding: 2px 6px; border-radius: 20px; font-weight: 600;
        }
        ...
        .admin-item .actions .btn-xs{
          padding: 2px 6px; border: none; border-radius: 20px;
          font-size: 8px; font-weight: 600; cursor: pointer; transition: 0.3s;
        }
        ...
        .admin-stats .stat{
          background: #1a1a1a; padding: 8px; border-radius: 8px; text-align: center;
        }
        ...
        <div id="page-chat" class="page">
          <div class="card">
            ...
            <div id="chatDetail" style="display:none;">
              ...
              <button onclick="closeChat()" style="margin-top:4px;background:none;border:none;color:#ff3b5c;cursor:pointer;font-size:11px;"><i class="fas fa-arrow-left"></i> Back</button>
            </div>
          </div>
        </div>
