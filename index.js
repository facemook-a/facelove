// FaceLove - Simple Version (without multer)
    ...
    <head>
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .top-nav .brand{ font-size: 20px; font-weight: 800; }
        .top-nav .brand i{ color: #ff3b5c; margin-right: 6px; }
        .top-nav .brand span{ color: #ff3b5c; }
        .top-nav a{ color: #888; font-size: 18px; text-decoration: none; transition: 0.3s; }
        ...
        .bottom-nav a span{ display: block; font-size: 9px; color: #555; margin-top: 2px; }
        ...
        .post-box .actions .btn-post:hover{ transform: translateY(-2px); box-shadow: 0 8px 25px rgba(255,59,92,0.3); }
        .feed-post{
          background: #141414;
          border-radius: 16px;
          padding: 14px 16px;
        ...
        .feed-post .header .info .name{ font-weight: 700; font-size: 14px; }
        .feed-post .header .info .time{ font-size: 11px; color: #555; }
        .feed-post .body{ font-size: 14px; line-height: 1.6; margin: 4px 0 8px; }
        .feed-post .actions{
          display: flex;
          gap: 16px;
          padding-top: 8px;
        ...
        .friend-item .info .status{ font-size: 11px; color: #555; }
        ...
        .empty{ text-align: center; padding: 30px 0; color: #555; }
        ...
        .profile-header .stats .stat .num{ font-size: 16px; font-weight: 700; }
        .profile-header .stats .stat .label{ font-size: 10px; color: #555; }
        ...
        .profile-header .edit-btn:hover{ border-color: #ff3b5c; }
        .admin-item{
          display: flex;
          align-items: center;
          gap: 8px;
        ...
        .admin-item .info .name{ font-weight: 600; font-size: 13px; }
        .admin-item .info .sub{ font-size: 10px; color: #555; }
        .admin-item .badge{
          font-size: 9px;
          padding: 2px 8px;
          border-radius: 20px;
        ...
        .admin-stats .stat .label{ font-size: 9px; color: #555; }
    ...
    <body>
      ...
      <div class="content">
          ...
          <div class="card post-box">
            ...
            <div class="actions">
              <div style="display:flex;gap:10px;align-items:center;flex:1;">
                <input type="text" id="mediaUrl" placeholder="Media URL (optional)" style="flex:1;padding:8px 12px;background:#1a1a1a;border:2px solid transparent;border-radius:30px;color:#fff;font-size:13px;outline:none;transition:0.3s;">
              </div>
        ...
        <div id="page-chat" class="page">
          <div class="card">
            ...
            <div id="chatDetail" style="display:none;">
              ...
              <button onclick="closeChat()" style="margin-top:6px;background:none;border:none;color:#ff3b5c;cursor:pointer;font-size:12px;"><i class="fas fa-arrow-left"></i> Back</button>
            </div>
          </div>
        </div>
        ...
        <div id="page-admin" class="page">
          <div class="card">
            <div class="title"><i class="fas fa-crown"></i> Admin</div>
      ...
      <script>
        ...
        function renderPost(p) {
          ...
          const mediaHtml = p.mediaUrl ? 
            (p.mediaUrl.match(/\\.(mp4|webm|ogg)$/) ? 
              '<video controls src="'+p.mediaUrl+'" style="width:100%;border-radius:10px;margin-top:6px;max-height:300px;"></video>' : 
              '<img src="'+p.mediaUrl+'" style="width:100%;border-radius:10px;margin-top:6px;max-height:300px;object-fit:cover;">') : '';
          return \`
            <div class="feed-post">
              <div class="header">
        ...
        async function loadFriends() {
          try {
            ...
            document.getElementById('friendsList').innerHTML = data.friends.length ? 
              data.friends.map(f => '<div class="friend-item"><div class="avatar">'+f.name.charAt(0).toUpperCase()+'</div><div class="info"><div class="name">'+f.name+'</div><div class="status">Friend</div></div></div>').join('') :
        ...
        async function loadAdmin() {
          try {
            ...
            html += '<div style="margin:10px 0 4px;"><strong style="color:#ff3b5c;">Posts</strong></div>';
